    ...
    return (
      <div className={cn("mx-auto w-full", widths.wide, className)}>
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
          ...
          <aside className="w-full shrink-0 lg:w-[280px] lg:sticky lg:top-[calc(var(--ls-header-offset,var(--ls-header-h,76px))+68px)] lg:self-start lg:z-10 transition-[top] duration-300">
            {aside}
          </aside>
        </div>
      </div>
