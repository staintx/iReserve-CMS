...
router.get("/me/availability", protect, authorize("admin", "manager"), ctrl.getMyAvailability);
router.put("/me/availability", protect, authorize("admin", "manager"), ctrl.setMyAvailability);
